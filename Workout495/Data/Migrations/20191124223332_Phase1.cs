        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Weight = table.Column<double>(nullable: false),
                    BMI = table.Column<double>(nullable: false),
                    ProgressPointDate = table.Column<DateTime>(nullable: false),
                    Created = table.Column<DateTime>(nullable: true),
                    Changed = table.Column<DateTime>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProgressPoints", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GoalsId = table.Column<int>(nullable: true),
                    ProgressPointsId = table.Column<int>(nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NumberOfCompletions = table.Column<int>(nullable: false),

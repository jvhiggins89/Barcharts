...
namespace Workout495.Migrations
{
    ...
    [Migration("20191204145234_goalsAndProgPseed-ProgPFK")]
    partial class goalsAndProgPseedProgPFK
    {
            ...
            modelBuilder.Entity("Workout495.Models.Goals", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            BMI = 23.0,
                            Changed = new DateTime(2019, 12, 4, 9, 52, 33, 831, DateTimeKind.Local).AddTicks(8480),
                            Created = new DateTime(2019, 12, 4, 9, 52, 33, 834, DateTimeKind.Local).AddTicks(6410),
                        ...
                        new
                        {
                            Id = 2,
                            BMI = 18.0,
                            Changed = new DateTime(2019, 12, 4, 9, 52, 33, 834, DateTimeKind.Local).AddTicks(7308),
                            Created = new DateTime(2019, 12, 4, 9, 52, 33, 834, DateTimeKind.Local).AddTicks(7329),
            ...
            modelBuilder.Entity("Workout495.Models.ProgressPoints", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            BMI = 28.0,
                            Changed = new DateTime(2019, 12, 4, 9, 52, 33, 835, DateTimeKind.Local).AddTicks(1455),
                            Created = new DateTime(2019, 12, 4, 9, 52, 33, 835, DateTimeKind.Local).AddTicks(2013),
                        ...
                        new
                        {
                            Id = 2,
                            BMI = 16.0,
                            Changed = new DateTime(2019, 12, 4, 9, 52, 33, 835, DateTimeKind.Local).AddTicks(2631),
                            Created = new DateTime(2019, 12, 4, 9, 52, 33, 835, DateTimeKind.Local).AddTicks(2648),

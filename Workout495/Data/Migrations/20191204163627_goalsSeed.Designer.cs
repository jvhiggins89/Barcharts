...
namespace Workout495.Migrations
{
    ...
    [Migration("20191204163627_goalsSeed")]
    partial class goalsSeed
    {
            ...
            modelBuilder.Entity("Workout495.Models.Goals", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            BMI = 17.0,
                            Changed = new DateTime(2019, 12, 4, 11, 36, 26, 495, DateTimeKind.Local).AddTicks(6293),
                            Created = new DateTime(2019, 12, 4, 11, 36, 26, 498, DateTimeKind.Local).AddTicks(7277),
                        ...
                        new
                        {
                            Id = 2,
                            BMI = 11.0,
                            Changed = new DateTime(2019, 12, 4, 11, 36, 26, 498, DateTimeKind.Local).AddTicks(8287),
                            Created = new DateTime(2019, 12, 4, 11, 36, 26, 498, DateTimeKind.Local).AddTicks(8311),

...
namespace Workout495.Migrations
{
    ...
    [Migration("20191204163756_goalsSeed2")]
    partial class goalsSeed2
    {
            ...
            modelBuilder.Entity("Workout495.Models.Goals", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            BMI = 12.0,
                            Changed = new DateTime(2019, 12, 4, 11, 37, 56, 235, DateTimeKind.Local).AddTicks(7478),
                            Created = new DateTime(2019, 12, 4, 11, 37, 56, 238, DateTimeKind.Local).AddTicks(6286),
                        ...
                        new
                        {
                            Id = 2,
                            BMI = 11.0,
                            Changed = new DateTime(2019, 12, 4, 11, 37, 56, 238, DateTimeKind.Local).AddTicks(7192),
                            Created = new DateTime(2019, 12, 4, 11, 37, 56, 238, DateTimeKind.Local).AddTicks(7212),
            ...
            modelBuilder.Entity("Workout495.Models.ProgressPoints", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            BMI = 13.0,
                            Changed = new DateTime(2019, 12, 4, 11, 37, 56, 238, DateTimeKind.Local).AddTicks(7774),
                            Created = new DateTime(2019, 12, 4, 11, 37, 56, 238, DateTimeKind.Local).AddTicks(7781),
                        ...
                        new
                        {
                            Id = 2,
                            BMI = 10.0,
                            Changed = new DateTime(2019, 12, 4, 11, 37, 56, 238, DateTimeKind.Local).AddTicks(9768),
                            Created = new DateTime(2019, 12, 4, 11, 37, 56, 238, DateTimeKind.Local).AddTicks(9780),

...
namespace Workout495.Migrations
{
    ...
    [Migration("20191208213136_seeddata3")]
            ...
            modelBuilder.Entity("Workout495.Models.Goals", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            BMI = 26.0,
                            Changed = new DateTime(2019, 12, 8, 16, 31, 35, 902, DateTimeKind.Local).AddTicks(132),
                            Created = new DateTime(2019, 12, 8, 16, 31, 35, 905, DateTimeKind.Local).AddTicks(8633),
                        ...
                        new
                        {
                            Id = 2,
                            BMI = 17.0,
                            Changed = new DateTime(2019, 12, 8, 16, 31, 35, 905, DateTimeKind.Local).AddTicks(9637),
                            Created = new DateTime(2019, 12, 8, 16, 31, 35, 905, DateTimeKind.Local).AddTicks(9658),
            ...
            modelBuilder.Entity("Workout495.Models.ProgressPoints", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            BMI = 21.0,
                            Changed = new DateTime(2019, 12, 8, 16, 31, 35, 906, DateTimeKind.Local).AddTicks(4504),
                            Created = new DateTime(2019, 12, 8, 16, 31, 35, 906, DateTimeKind.Local).AddTicks(5158),
                        ...
                        new
                        {
                            Id = 2,
                            BMI = 24.0,
                            Changed = new DateTime(2019, 12, 8, 16, 31, 35, 906, DateTimeKind.Local).AddTicks(5981),
                            Created = new DateTime(2019, 12, 8, 16, 31, 35, 906, DateTimeKind.Local).AddTicks(6009),
